...
namespace ContractsApi.Migrations
{
    ...
    [Migration("20230802210101_ApelidoNotMandatory")]
    partial class ApelidoNotMandatory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContractsApi.Data.Entities.Clube", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ContractsApi.Data.Entities.Contrato", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ContractsApi.Data.Entities.Fornecedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ContractsApi.Data.Entities.Material", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ContractsApi.Data.Entities.Contrato", b =>
                {
                    b.HasOne("ContractsApi.Data.Entities.Clube", "Clube")
                        .WithMany()
                    ...
                    b.HasOne("ContractsApi.Data.Entities.Fornecedor", "Fornecedor")
                        .WithMany()
                    ...
                    b.HasOne("ContractsApi.Data.Entities.Material", "Material")
                        .WithMany()
